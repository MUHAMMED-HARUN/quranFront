...
import { InstituteClassTable, InstituteClassForm, InstituteClassCard } from "../components";
import { useInstituteClassStore } from "../store/instituteClassStore";
import { useDeleteInstituteClassMutation } from "../hooks";

export const InstituteClassesPage = () => {
    const {
        selectedIds,
        openForm,
        openCard,
    ...
    const deleteMutation = useDeleteInstituteClassMutation();
    ...
    const handleDelete = () => {
        if (window.confirm("هل أنت متأكد من حذف الارتباط المحددة؟")) {
