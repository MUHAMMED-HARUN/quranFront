...
import { StudentTable, StudentForm, StudentCard } from "../components";
import { useStudentStore } from "../store/studentStore";
import { useDeleteStudentMutation } from "../hooks";
...
export const StudentsPage = () => {
    ...
    const handleDelete = () => {
        if (window.confirm("هل أنت متأكد من حذف الطالب المحدد؟")) {
