...
import { DailyEvaluationTable, DailyEvaluationForm, DailyEvaluationCard } from "../components";
import { useDailyEvaluationStore } from "../store/dailyEvaluationStore";
import { useDeleteDailyEvaluationMutation } from "../hooks/useDailyEvaluations";

export const DailyEvaluationsPage = () => {
    const {
        selectedIds,
        openForm,
        openCard,
        setFilters,
        clearSelection,
    } = useDailyEvaluationStore();

    const deleteMutation = useDeleteDailyEvaluationMutation();
