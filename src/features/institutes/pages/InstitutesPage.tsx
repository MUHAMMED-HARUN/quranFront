...
import { InstituteTable, InstituteForm, InstituteCard } from "../components";
import { useInstituteStore } from "../store/instituteStore";
import { useDeleteInstituteMutation } from "../hooks";
...
export const InstitutesPage = () => {
    ...
    const deleteMutation = useDeleteInstituteMutation();
    ...
    const handleDelete = () => {
        if (window.confirm("هل أنت متأكد من حذف الجهة المحددة؟")) {
