...
import { TeacherTable, TeacherForm, TeacherCard } from "../components";
import { useTeacherStore } from "../store/teacherStore";
import { useDeleteTeacherMutation } from "../hooks";
...
export const TeachersPage = () => {
    ...
    const handleDelete = () => {
        if (window.confirm("هل أنت متأكد من حذف المعلم المحدد؟")) {
