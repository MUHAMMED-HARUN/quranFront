...
الForm
    استدعي ال Api Create(CreateTeacherAssigmentCommand)
       بالنسبة لل TeacherID
       يتم البحث عن طريق رقم الهوية
       استخدم Youtube-Style Autocomplete Pattern الذي يوجد توثيقه في ال @FrontUseCase.md لجلب الTeacher عبر البحث عن رقم الهوية
       ...
       يتم البحث عن طريق رقم الهوية
       استخدم Youtube-Style Autocomplete Pattern الذي يوجد توثيقه في ال @FrontUseCase.md لجلب الSubject عبر البحث عن اسم ال Subject
        البيانات التي ستجلبها في ال onchange 
            id
            name
        البيانات التي ستعرضها في ال Autocomplete
